...
exports.mobile = function (req, res) {
  ...
  var temp2 = "&number=" + data.number + "&provider_id=" + data.provider_id + "&amount=" + data.amount + "&client_id=" + data.client_id + "&live=" + data.live + "";
...
exports.dth = function (req, res) {
  const data = req.body;

  var temp1 = "https://www.pay2all.in/web-api/paynow?api_token=4gQWeK1xZes3m3eQKjUjSZfjvNCeeD8ZniN8d8wN7vyrmqYk5ru7M0wGPCKB"
  var temp2 = "&number=" + data.number + "&cnumber=" + data.cnumber + "&provider_id=" + data.provider_id + "&amount=" + data.amount + "&client_id=" + data.client_id + "&live=" + data.live + "";
  const httpval = temp1 + temp2;
  console.log(httpval);
  const request = require('request')
  // request.get('https://www.pay2all.in/web-api/paynow?api_token=4gQWeK1xZes3m3eQKjUjSZfjvNCeeD8ZniN8d8wN7vyrmqYk5ru7M0wGPCKB&number=7200447673&provider_id=112&amount=1&client_id=sskk',
...
exports.ebbillpay = function (req, res) {
  const data = req.body;
